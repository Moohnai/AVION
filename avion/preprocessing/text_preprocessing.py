...
#     generated_csv_path = "../../home/mona/SSVLI/dataset/epic_kitchens/epic_captions_train.csv"
...
#     encoded_label_train_dict_epic = {id:text_encoding(text) for _, (id, text,_) in df_train.iterrows()}
...
#     torch.save(encoded_label_train_dict_epic, "../../home/mona/SSVLI/dataset/epic_kitchens/epic_train_label_text_dict.pt")
#     torch.save(encoded_video_cation_dict, "../../home/mona/SSVLI/dataset/epic_kitchens/epic_train_video_caption_text_dict.pt")
#     torch.save(encoded_image_cation_dict, "../../home/mona/SSVLI/dataset/epic_kitchens/epic_train_image_caption_text_dict.pt")
#     torch.save(encoded_mixed_cation_dict, "../../home/mona/SSVLI/dataset/epic_kitchens/epic_train_mixed_caption_text_dict.pt")
